...
public enum CustomComboPreset
{
    ...
    [CustomComboInfo(
        "Any",
        "This should not be displayed. This always returns true when used with IsEnabled.",
        ADV.JobID
    )]
    AdvAny = 0,
    ...
    [CustomComboInfo(
        "Disable for VerRaise",
        "Doesn't apply this feature to RDM's VerRaise.",
        ADV.JobID
    )]
    ...
    [CustomComboInfo(
        "Replace VerRaise by Vercure instead",
        "Do those puny dead bodies really deserve you wasting 2 GCDs?",
        ADV.JobID
    )]
    AdvVerRaiseToVerCureFeature = 1003,

    [CustomComboInfo(
        "Variant Raise Feature",
    ...
    [CustomComboInfo(
        "Stance Removal over Shirk",
        "Replace Shirk by your Stance removal action when it is on cooldown and your stance is up.",
        ADV.JobID
    )]
    ...
    [CustomComboInfo(
        "Malefic to Astral/Umbral Draw",
        "Replace Malefic with Astral/Umbral Draw when no card is drawn and you can draw.",
        AST.JobID
    )]
    ...
    [CustomComboInfo(
        "Gravity to Astral/Umbral Draw",
        "Replace Gravity with with Astral/Umbral Draw when no card is drawn and you can draw..",
        AST.JobID
    )]
    AstrologianGravityDrawFeature = 3322,

    [CustomComboInfo(
        "Play to Astral/Umbral Draw",
    ...
    [CustomComboInfo(
        "Malefic/Gravity to Arcana",
        "Replace Malefic & Gravity by Lord of Crowns when drawn.",
        AST.JobID
    )]
    AstrologianMaleficArcanaFeature = 3325,

    [CustomComboInfo(
        "Benefic II to Benefic Level Sync",
        "Replace Benefic 2 with Benefic when below level 26 in synced content.",
        AST.JobID
    )]
    ...
    [CustomComboInfo(
        "Enochian Feature",
        "Replace Fire 4 and Blizzard 4 with whichever action you can currently use.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Flare Star feature",
        "Replace Fire 4 and Blizzard 4 with Flare Star when you have 6 astral soul.",
        BLM.JobID
    )]
    ...
    [ParentCombo(BlackEnochianFeature)]
    [CustomComboInfo(
        "Enochian Despair Feature",
        "Replace Fire 4 and Blizzard 4 with Despair when in Astral Fire with less than 2400 mana.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Enochian Despair into Flare Star Feature",
        "Replace Fire 4 and Blizzard 4 with Flare Star when you have 6 astral soul and 0 mana.",
        BLM.JobID
    )]
    ...
    [ParentCombo(BlackEnochianFeature)]
    [CustomComboInfo(
        "Enochian No Sync Feature",
        "Fire 4 and Blizzard 4 will not sync to Fire 1 and Blizzard 1.",
        BLM.JobID
    )]
    BlackEnochianNoSyncFeature = 2518,

    [CustomComboInfo(
        "Transpose into Umbral Soul",
        "Replace Transpose with Umbral Soul when Umbral Soul is usable.",
        BLM.JobID
    )]
    BlackTransposeUmbralSoulFeature = 2502,

    [CustomComboInfo(
        "Umbral Soul into Transpose",
        "Replace Umbral Soul with Transpose when Umbral Soul is not usable.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Ley Lines with BTL when Ley Lines is active.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Fire 1/3 Feature",
        "Fire 1 becomes Fire 3 outside of Astral Fire, and when Firestarter is up.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Fire 1/3 Option",
        "Fire 1 will stay Fire 3 when not at max Astral Fire.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Fire 1/3 Option (2)",
        "Fire 1 does not become Fire 3 outside of Astral Fire.",
        BLM.JobID
    )]
    BlackFireOption2 = 2516,

    [CustomComboInfo(
        "Blizzard 1/3 Feature",
        "Replace Blizzard 1 with Blizzard 3 when unlocked and becomes Paradox when available.",
        BLM.JobID
    )]
    BlackBlizzardFeature = 2505,

    [CustomComboInfo(
        "Freeze/Flare Feature",
        "Freeze and Flare become whichever action you can currently use.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Fire 2 Feature",
        "(High) Fire 2 becomes Flare when in Astral Fire and is optimal.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Fire 2/Ice 2 Option",
        "Fire 2 and Blizzard 2 will not change unless you're at max Astral Fire or Umbral Ice.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        "Umbral Soul Feature",
        "Replace your ice spells with Umbral Soul, while in Umbral Ice and having no target.",
        BLM.JobID
    )]
    BlackSpellsUmbralSoulFeature = 2517,

    [CustomComboInfo(
        "Scathe/Xenoglossy Feature",
        "Scathe becomes Xenoglossy when available.",
        BLM.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Heavy Shot with Straight Shot/Refulgent Arrow when available.",
        BRD.JobID
    )]
    ...
    [CustomComboInfo(
        "Iron Jaws Feature",
        "Replace Iron Jaws with Caustic Bite/Stormbite depending on which is not present on the target.",
        BRD.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Burst Shot and Quick Nock with Apex Arrow when gauge is full.",
        BRD.JobID
    )]
    BardApexFeature = 2304,

    [CustomComboInfo(
        "Quick Nock into Wide Volley/Shadowbite",
        "Replace Quick Nock with Wide Volley/Shadowbite when available.",
        BRD.JobID
    )]
    ...
    [CustomComboInfo(
        "A Wide Barrage of Shadowbites",
        "Replace Quick Nock with Barrage when off cooldown and Wide Volley/Shadowbite is available.",
        BRD.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Perfect Bloodletter Feature",
        "Replace Bloodletter with Pitch Perfect when Repertoire charges are full.",
        BRD.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Expiring Perfect Bloodletter Feature",
    ...
    [CustomComboInfo(
        "Bloodletter Feature",
        "Replace Bloodletter with Empyreal Arrow and Sidewinder depending on which is available.",
        BRD.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Rain of Death Feature",
        "Replace Rain of Death with Empyreal Arrow and Sidewinder depending on which is available.",
        BRD.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Perfect Rain of Death Feature",
        "Replace Rain of Death with Pitch Perfect when Repertoire charges are full.",
        BRD.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Expiring Perfect Rain of Death Feature",
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Empyreal Arrow Feature",
        "Replace Empyreal Arrow with Sidewinder depending on which is available.",
        BRD.JobID
    )]
    ...
    [CustomComboInfo(
        "Sidewinder Feature",
        "Replace Sidewinder with Empyreal Arrow depending on which is available.",
        BRD.JobID
    )]
    BardSidewinderFeature = 2309,

    [CustomComboInfo(
        "Radiant Voice Feature",
        "Replace Radiant Finale with Battle Voice if Battle Voice is available.",
        BRD.JobID
    )]
    BardRadiantVoiceFeature = 2310,

    [CustomComboInfo(
        "Radiant Strikes Feature",
    ...
    [CustomComboInfo(
        "Barrage Feature",
        "Replace Barrage with Straight Shot if you have Straight Shot Ready (unless Shadowbite is ready).",
        BRD.JobID
    )]
    ...
    [CustomComboInfo(
        "Bloodletter to Rain of Death",
        "Replace Bloodletter with Rain of Death if there are no self-applied DoTs on your target.",
        BRD.JobID
    )]
    BardBloodRainFeature = 2313,

    [CustomComboInfo(
        "Cycling Song Feature",
    ...
    [CustomComboInfo(
        "Fan Dance 3 Feature",
        "Replace Fan Dance and Fan Dance 2 with Fan Dance 3 when available.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Dance Step Combo",
        "Replace Standard Step and Technical Step with each dance step while dancing.",
        DNC.JobID
    )]
    DancerDanceStepCombo = 3802,

    [CustomComboInfo(
        "Flourishing Fan Dance 3",
        "Replace Flourish with Fan Dance 3 when available.",
        DNC.JobID
    )]
    DancerFlourishFan3Feature = 3810,

    [CustomComboInfo(
        "Flourishing Fan Dance 4",
        "Replace Flourish with Fan Dance 4 when available.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Cascade with its procs and combos as they activate.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Single Target to Procs",
        "Replace Cascade and Fountain with Reverse Cascade and Fountainfall respectively when available.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Single Target Saber Dance Tech Step",
        "Use Saber Dance at >= 50 Esprit during Technical Step.",
        DNC.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Single Target Dance of the Dawn",
    ...
    [CustomComboInfo(
        "AoE Multibutton",
        "Replace Windmill with its procs and combos as they activate.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Devilment Feature",
        "Replace Devilment with Starfall Dance when active.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Chocobo Partner Feature",
        "Also applies if you are out of duty and that your Chocobo is summoned.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Last Dance Feature",
        "Replace Standard Step by Last Dance if available.",
        DNC.JobID
    )]
    ...
    [CustomComboInfo(
        "Stalwart Soul Combo",
        "Replace Stalwart Soul with its combo chain.",
        DRK.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Carve and Spit, and Abyssal Drain with Blood Weapon/Delirium when available.",
        DRK.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Quietus and Bloodspiller with Living Shadow when available.",
        DRK.JobID
    )]
    DarkLivingShadowFeature = 3205,

    [CustomComboInfo(
        "Living Shadowbringer Feature",
        "Replace Living Shadow with Shadowbringer when charges are available and your Shadow is present.",
        DRK.JobID
    )]
    DarkLivingShadowbringerFeature = 3208,

    [CustomComboInfo(
        "Missing Shadowbringer Feature",
    ...
    [ParentCombo(DragoonFullThrustCombo)]
    [CustomComboInfo(
        "Double Chaos Thrust Option",
        "Replicates the Full Thrust combo while not in the Chaotic Thrust combo.",
        DRG.JobID
    )]
    ...
    [CustomComboInfo(
        "Chaos Thrust Disembowel Option",
    ...
    [ParentCombo(DragoonChaosThrustCombo)]
    [CustomComboInfo(
        "Double Full Thrust Option",
        "Replicates the Chaotic Thrust combo while not in the Full Thrust combo.",
        DRG.JobID
    )]
    DragoonDoubleChaosComboOption = 2214,

    [CustomComboInfo(
        "Coerthan Torment Combo",
        "Replace Coerthan Torment with its combo chain.",
        DRG.JobID
    )]
    DragoonCoerthanTormentCombo = 2202,

    [CustomComboInfo(
        "Coerthan Torment Wyrmwind Feature",
        "Replace Coerthan Torment with Wyrmwind Thrust when you have two Firstminds' Focus.",
        DRG.JobID
    )]
    ...
    [CustomComboInfo(
        "Lance Charge to Battle Litany",
        "Replace Lance Charge Battle Litany when available and Lance Charge is on cooldown.",
        DRG.JobID
    )]
    ...
    [CustomComboInfo(
        "Burst Strike Feature",
        "Replace Solid Barrel with Burst Strike when charges are full.",
        GNB.JobID
    )]
    GunbreakerBurstStrikeFeature = 3710,

    [CustomComboInfo(
        "Gnashing Fang Continuation",
        "Replace Gnashing Fang with Continuation moves when appropriate.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Burst Strike with Continuation moves when appropriate.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Fated Circle with Continuation moves when appropriate.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        "Sonic Shock Feature",
        "Replace Bow Shock and Sonic Break with one or the other depending on which is on cooldown.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Demon Slaughter with its combo chain.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        "Fated Circle Feature",
        "In addition to the Demon Slaughter combo, add Fated Circle when charges are full.",
        GNB.JobID
    )]
    GunbreakerFatedCircleFeature = 3706,

    [CustomComboInfo(
        "Empty Bloodfest Feature",
        "Replace Burst Strike and Fated Circle with Bloodfest if the powder gauge is empty.",
        GNB.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "No Mercy Bow Shock/Sonic Break Feature",
        "Replace No Mercy with Bow Shock, and then Sonic Break, while No Mercy is active.",
        GNB.JobID
    )]
    GunbreakerNoMercyFeature = 3708,

    [CustomComboInfo(
        "No Mercy Double Down Feature",
    ...
    [CustomComboInfo(
        "No Mercy Always Double Down Feature",
        "Replace No Mercy with Double Down while No Mercy is active.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        "Double Down Feature",
        "Replace Burst Strike and Fated Circle with Double Down when available.",
        GNB.JobID
    )]
    ...
    [CustomComboInfo(
        "Hypercharge Combo",
        "Replace Clean Shot combo with Heat Blast while overheated.",
        MCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Hyperfire Feature",
        "Replace Hypercharge with Wildfire if available and you have a target.",
        MCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Overdrive Feature",
        "Replace Rook Autoturret and Automaton Queen with Overdrive while active.",
        MCH.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Gauss Round / Ricochet Feature",
        "Replace Gauss Round and Ricochet with one or the other depending on which has more charges.",
        MCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Gauss Round / Ricochet Overheat Option",
        "Replace Gauss Round and Ricochet with one or the other only while overheated.",
        MCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Hot Shot (Air Anchor) / Drill / Chainsaw Feature",
        "Replace Hot Shot (Air Anchor), Drill, and Chainsaw with whichever is available.",
        MCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Hot Shot (Air Anchor) / Chainsaw Feature",
        "Replace Hot Shot (Air Anchor) and Chainsaw with whichever is available.",
        MCH.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Bioblaster / Chainsaw Feature",
        "Replace Bioblaster with whichever of Bioblaster or Chainsaw is available.",
        MCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Monkey Bootshine Steeled Meditation Feature",
    ...
    [ParentCombo(MonkMonkeyMode)]
    [CustomComboInfo(
        "Automatic Chakra Feature",
        "Replace Bootshine/Leaping Opo with The Forbidden Chakra when your Fifth Chakra is open.",
        MNK.JobID
    )]
    ...
    [CustomComboInfo(
        "Opo feature",
        "Replace Bootshine/Leaping Opo with Dragon Kick if you don't have any Opo's fury stack.",
        MNK.JobID
    )]
    MonkOpoFeature = 2017,
    ...
    [CustomComboInfo(
        "Bootshine Steeled Meditation Feature",
        "Replace Bootshine/Leaping Opo with Steeled Meditation when out of combat and the Fifth Chakra is not open.",
        MNK.JobID
    )]
    ...
    [CustomComboInfo(
        "Raptor feature",
        "Replace True Strike with Twin Snakes if you don't have any Raptor's fury stack.",
        MNK.JobID
    )]
    ...
    [CustomComboInfo(
        "Coeurl feature",
        "Replace Snap Punch with Demolish if you don't have any Coeurl's fury stack.",
        MNK.JobID
    )]
    ...
    [CustomComboInfo(
        "Enlightened Meditation Feature",
    ...
    [ParentCombo(MonkAoECombo)]
    [CustomComboInfo(
        "AoE Form Shift Feature",
        "Replace Masterful Blitz with Form Shift when out of combat and you don't have Formless Fist.",
        MNK.JobID
    )]
    ...
    [ParentCombo(MonkAoECombo)]
    [CustomComboInfo(
        "Automatic AoE Chakra Feature",
        "Replace Masterful Blitz with Enlightenment when your Fifth Chakra is open.",
        MNK.JobID
    )]
    MonkAoEAutoChakraFeature = 2028,

    [CustomComboInfo(
        "Perfect Balance Feature",
        "Replace Perfect Balance with Masterful Blitz when you have 3 Beast Chakra.",
        MNK.JobID
    )]
    MonkPerfectBalanceFeature = 2004,

    [CustomComboInfo(
        "Riddle of Brotherly Fire",
        "Replace Riddle of Fire with Brotherhood when on cooldown.",
        MNK.JobID
    )]
    MonkRiddleOfFireBrotherhood = 2009,

    [CustomComboInfo(
        "Riddle of Fire and Wind",
        "Replace Riddle of Fire with Riddle of Wind when on cooldown.",
        MNK.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Aeolian Edge with Ninjutsu if any Mudra are used.",
        NIN.JobID
    )]
    NinjaAeolianNinjutsuFeature = 3008,

    [CustomComboInfo(
        "Aeolian Edge / Raiju Feature",
        "Replace the Aeolian Edge combo with Fleeting Raiju when available.",
        NIN.JobID
    )]
    NinjaAeolianEdgeRaijuFeature = 3013,

    [CustomComboInfo(
        "Armor Crush / Ninjutsu Feature",
        "Replace Armor Crush with Ninjutsu if any Mudra are used.",
        NIN.JobID
    )]
    NinjaArmorCrushNinjutsuFeature = 3015,

    [CustomComboInfo(
        "Armor Crush / Raiju Feature",
        "Replace the Armor Crush combo with Forked Raiju when available.",
        NIN.JobID
    )]
    NinjaArmorCrushRaijuFeature = 3012,

    [CustomComboInfo(
        "Hakke Mujinsatsu Combo",
        "Replace Hakke Mujinsatsu with its combo chain.",
        NIN.JobID
    )]
    NinjaHakkeMujinsatsuCombo = 3003,

    [CustomComboInfo(
        "Hakke Mujinsatsu / Ninjutsu Feature",
        "Replace Hakke Mujinsatsu with Ninjutsu if any Mudra are used.",
        NIN.JobID
    )]
    ...
    [CustomComboInfo(
        "Ninjitsu / Forked Raiju Feature",
        "Replace Ninjitsu with Forked Raiju when available and no Mudra are active.",
        NIN.JobID
    )]
    ...
    [CustomComboInfo(
        "Ninjitsu / Fleeting Raiju Feature",
        "Replace Ninjitsu with Fleeting Raiju when available and no Mudra are active.",
        NIN.JobID
    )]
    ...
    [CustomComboInfo(
        "Kassatsu Chi/Jin Feature",
        "Replace Chi with Jin while Kassatsu is up if you have Enhanced Kassatsu.",
        NIN.JobID
    )]
    NinjaKassatsuChiJinFeature = 3006,

    [CustomComboInfo(
        "Hide to Mug/Dokumori",
        "Replace Hide with Mug/Dokumori while in combat or hidden.",
        NIN.JobID
    )]
    ...
    [CustomComboInfo(
        "Hide to Ninjutsu",
        "Replace Hide with Ninjutsu if any Mudra are active. Takes precedence over Hide to Mug/Dokumori.",
        NIN.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Royal Authority with its combo chain.",
        PLD.JobID
    )]
    ...
    [CustomComboInfo(
        "Royal Authority Divine Might Feature",
        "Replace Royal Authority with Holy Spirit when Divine Might would overcap.",
        PLD.JobID
    )]
    ...
    [ParentCombo(PaladinRoyalAuthorityCombo)]
    [CustomComboInfo(
        "Royal Authority Fight or Flight Feature",
        "Replace Royal Authority with Holy Spirit during Fight or Flight when Divine Might is active.",
        PLD.JobID
    )]
    ...
    [ParentCombo(PaladinRoyalAuthorityCombo)]
    [CustomComboInfo(
        "Royal Authority Confiteor Feature",
        "Replace Royal Authority with Confiteor and its combo chain when under the effect of Requiescat.",
        PLD.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Royal Authority with Goring Blade when available.",
        PLD.JobID
    )]
    ...
    [CustomComboInfo(
        "Prominence Divine Might Feature",
        "Replace Prominence with Holy Circle when Divine Might is active.",
        PLD.JobID
    )]
    ...
    [ParentCombo(PaladinProminenceCombo)]
    [CustomComboInfo(
        "Prominence Confiteor Feature",
        "Replace Prominence with Confiteor and its combo chain when under the effect of Requiescat.",
        PLD.JobID
    )]
    ...
    [ParentCombo(PaladinProminenceCombo)]
    [CustomComboInfo(
        "Prominence Goring Blade Feature",
        "Replace Prominence with Goring Blade when available.",
        PLD.JobID
    )]
    PaladinProminenceGoringBladeComboFeature = 1920,

    [CustomComboInfo(
        "Requiescat Fight or Flight Feature",
        "Replace Requiescat with Fight or Flight when off cooldown or if it will be ready sooner.",
        PLD.JobID
    )]
    PaladinRequiescatFightOrFlightFeature = 1914,

    [CustomComboInfo(
        "Requiescat Confiteor",
    ...
    [CustomComboInfo(
        "Confiteor Feature",
        "Replace Holy Spirit/Circle with Confiteor while under the effect of Requiescat.",
        PLD.JobID
    )]
    PaladinConfiteorFeature = 1907,

    [CustomComboInfo(
        "Holy Spirit Level Sync",
        "Replace Holy Spirit with Shield Lob when below level 64 in synced content.",
        PLD.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Scornful Spirits Feature",
        "Replace Spirits Within/Expiacion and Circle of Scorn with whichever is available soonest.",
        PLD.JobID
    )]
    PaladinScornfulSpiritsFeature = 1908,

    [CustomComboInfo(
        "Shields on your Feet Feature",
        "Replace Shield Bash with Low Blow when available.",
        PLD.JobID
    )]
    ...
    [CustomComboInfo(
        "Subtractive Single-Target Combo",
    ...
    [CustomComboInfo(
        "Creature Muse/Motif Combo",
        "Replace Creature Motifs with Creature Muses when the Creature Canvas is painted.",
        PCT.JobID
    )]
    PictomancerCreatureMotifCombo = 4206,

    [CustomComboInfo(
        "Creature Muse/Mog of the Ages Combo",
    ...
    [CustomComboInfo(
        "Weapon Muse/Motif Combo",
        "Replace Hammer Motif with Striking Muse when the Weapon Canvas is painted.",
        PCT.JobID
    )]
    ...
    [CustomComboInfo(
        "Hammer Time",
        "Replace Hammer Motif with Hammer Brush and its combo chain when they are usable.",
        PCT.JobID
    )]
    PictomancerWeaponHammerCombo = 4209,

    [CustomComboInfo(
        "Landscape Muse/Motif Combo",
        "Replace Starry Sky Motif with Starry Muse when the Landscape Canvas is painted.",
        PCT.JobID
    )]
    PictomancerLandscapeMotifCombo = 4210,

    [CustomComboInfo(
        "Landscape Muse/Star Prism Combo",
        "Replace Starry Muse with Star Prism when it is usable.",
        PCT.JobID
    )]
    ...
    [CustomComboInfo(
        "Holy Comet Combo",
        "Replace Holy in White with Comet in Black when usable.",
        PCT.JobID
    )]
    ...
    [CustomComboInfo(
        "Slice Gibbet Feature",
        "Replace Infernal Slice with Gibbet while Reaving or Enshrouded.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Slice Gallows Feature",
        "Replace Infernal Slice with Gallows while Reaving or Enshrouded.",
        RPR.JobID
    )]
    ReaperSliceGallowsFeature = 3904,

    [CustomComboInfo(
        "Slice Enhanced Soul Reaver Feature",
        "Replace Infernal Slice with whichever of Gibbet or Gallows is currently enhanced while Reaving.",
        RPR.JobID
    )]
    ReaperSliceEnhancedSoulReaverFeature = 3913,

    [CustomComboInfo(
        "Slice Enhanced Enshrouded Feature",
    ...
    [CustomComboInfo(
        "Slice Lemure's Feature",
        "Replace Infernal Slice with Lemure's Slice when two or more stacks of Void Shroud are active.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Slice Sacrificium Feature",
        "Replace Infernal Slice with with Sacrificium after 3 reapings.",
        RPR.JobID
    )]
    ReaperSliceSacrificiumFeature = 3946,

    [CustomComboInfo(
        "Slice Communio Feature",
        "Replace Infernal Slice with Communio when one stack of Shroud is left.",
        RPR.JobID
    )]
    ReaperSliceCommunioFeature = 3920,

    [CustomComboInfo(
        "Slice Soulsow Feature",
        "Replace Infernal Slice with Soulsow when out of combat and not active.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Shadow Gibbet Feature",
        "Replace Shadow of Death with Gibbet while Reaving or Enshrouded.",
        RPR.JobID
    )]
    ReaperShadowGibbetFeature = 3906,

    [CustomComboInfo(
        "Shadow Lemure's Feature",
        "Replace Shadow of Death with Lemure's Slice when two or more stacks of Void Shroud are active.",
        RPR.JobID
    )]
    ReaperShadowLemuresFeature = 3923,

    [CustomComboInfo(
        "Shadow Communio Feature",
        "Replace Shadow of Death with Communio when one stack of Shroud is left.",
        RPR.JobID
    )]
    ReaperShadowCommunioFeature = 3924,

    [CustomComboInfo(
        "Shadow Soulsow Feature",
        "Replace Shadow of Death with Soulsow when out of combat, not active, and you have no target.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Soul Gallows Feature",
        "Replace Soul Slice with Gallows while Reaving or Enshrouded.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Soul Gibbet Feature",
        "Replace Soul Slice with Gibbet while Reaving or Enshrouded.",
        RPR.JobID
    )]
    ReaperSoulGibbetFeature = 3926,

    [CustomComboInfo(
        "Soul Lemure's Feature",
        "Replace Soul Slice with Lemure's Slice when two or more stacks of Void Shroud are active.",
        RPR.JobID
    )]
    ReaperSoulLemuresFeature = 3927,

    [CustomComboInfo(
        "Soul Communio Feature",
        "Replace Soul Slice with Communio when one stack of Shroud is left.",
        RPR.JobID
    )]
    ReaperSoulCommunioFeature = 3928,

    [CustomComboInfo(
        "Soul Overcap Feature",
        "Replace Soul Slice with Blood Stalk not Enshrouded and greater-than 50 Soul Gauge is present.",
        RPR.JobID
    )]
    ReaperSoulOvercapFeature = 3934,

    [CustomComboInfo(
        "Soul (Scythe) Overcap Feature",
    ...
    [CustomComboInfo(
        "Scythe Guillotine Feature",
        "Replace Nightmare Scythe with Guillotine while Reaving or Enshrouded.",
        RPR.JobID
    )]
    ReaperScytheGuillotineFeature = 3907,

    [CustomComboInfo(
        "Scythe Lemure's Feature",
        "Replace Nightmare Scythe with Lemure's Scythe when two or more stacks of Void Shroud are active.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Scythe Sacrificium Feature",
        "Replace Nightmare Scythe with with Sacrificium after 3 reapings.",
        RPR.JobID
    )]
    ReaperScytheSacrificiumFeature = 3945,

    [CustomComboInfo(
        "Scythe Communio Feature",
        "Replace Nightmare Scythe with Communio when one stack is left of Shroud.",
        RPR.JobID
    )]
    ReaperScytheCommunioFeature = 3922,

    [CustomComboInfo(
        "Scythe Soulsow Feature",
        "Replace Nightmare Scythe with Soulsow when out of combat and not active.",
        RPR.JobID
    )]
    ReaperScytheSoulsowFeature = 3931,

    [CustomComboInfo(
        "Scythe Harvest Moon Feature",
        "Replace Nightmare Scythe with Harvest Moon when Soulsow is active and you have a target.",
        RPR.JobID
    )]
    ReaperScytheHarvestMoonFeature = 3932,

    [CustomComboInfo(
        "Enhanced Soul Reaver Feature",
        "Replace Gibbet and Gallows with whichever is currently enhanced while Reaving.",
        RPR.JobID
    )]
    ReaperEnhancedSoulReaverFeature = 3917,

    [CustomComboInfo(
        "Enhanced Enshrouded Feature",
        "Replace Gibbet and Gallows with whichever is currently enhanced while Enshrouded.",
        RPR.JobID
    )]
    ReaperEnhancedEnshroudedFeature = 3918,

    [CustomComboInfo(
        "Lemure's Soul Reaver Feature",
    ...
    [CustomComboInfo(
        "Communio Soul Reaver Feature",
        "Replace Gibbet, Gallows, and Guillotine with Communio when one stack is left of Shroud.",
        RPR.JobID
    )]
    ReaperCommunioSoulReaverFeature = 3912,

    [CustomComboInfo(
        "Enshroud Communio Feature",
        "Replace Enshroud with Communio when Enshrouded.",
        RPR.JobID
    )]
    ReaperEnshroudCommunioFeature = 3909,

    [CustomComboInfo(
        "Blood Stalk Gluttony Feature",
    ...
    [CustomComboInfo(
        "Prioritize Sacrificium over Lemure's",
        "Replace Lemure's Slice/Scythe with Sacrificium even when you have 2 Void Shroud.",
        RPR.JobID
    )]
    ReaperLemuresSacrificiumPriorityFeature = 3941,

    [CustomComboInfo(
        "Arcane Harvest Feature",
        "Replace Arcane Circle with Plentiful Harvest when you have stacks of Immortal Sacrifice.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Harpe with Soulsow when not active and out of combat or you have no target.",
        RPR.JobID
    )]
    ReaperHarpeHarvestSoulsowFeature = 3936,

    [CustomComboInfo(
        "Harpe Harvest Moon Feature",
        "Replace Harpe with Harvest Moon when Soulsow is active and you are in combat.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Enhanced Harpe Option",
        "Prevent replacing Harpe with Harvest Moon when Enhanced Harpe is active.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Combat Option",
        "Prevent replacing Harpe with Harvest Moon when not in combat.",
        RPR.JobID
    )]
    ReaperHarpeHarvestMoonCombatFeature = 3938,

    [CustomComboInfo(
        "Slice Perfectio Feature",
        "Replace Infernal Slice with Perfectio under Perfectio Parata.",
        RPR.JobID
    )]
    ReaperSlicePerfectioFeature = 3942,

    [CustomComboInfo(
        "Scythe Perfectio Feature",
        "Replace Nightmare Scythe with with Perfectio under Perfectio Parata.",
        RPR.JobID
    )]
    ReaperScythePerfectioFeature = 3943,

    [CustomComboInfo(
        "Harpe Perfectio Feature",
        "Replace Harpe with with Perfectio under Perfectio Parata.",
        RPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Verstone/Verfire Feature",
        "Replace Verstone/Verfire with Jolt when no proc is available.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "Verstone/Verfire Plus Feature",
        "Replace Verstone/Verfire with Veraero/Verthunder when various instant-cast effects are active.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "Deprioritize Grand Impact Plus",
    ...
    [CustomComboInfo(
        "Verstone/Verfire Plus Opener Feature (Stone)",
        "Replace Verstone with Veraero when out of combat.",
        RDM.JobID
    )]
    RedMageVerprocOpenerStoneFeature = 3506,

    [CustomComboInfo(
        "Verstone/Verfire Plus Opener Feature (Fire)",
        "Replace Verfire with Verthunder when out of combat.",
        RDM.JobID
    )]
    RedMageVerprocOpenerFireFeature = 3507,

    [CustomComboInfo(
        "Verstone/Verfire Mana Stacks Feature",
        "Replace Verstone/Verfire with Verflare/Verholy at 3 mana stacks.",
        RDM.JobID
    )]
    RedMageVerprocManaStacksFeature = 3515,

    [CustomComboInfo(
        "Verstone/Verfire Capstone Combo",
        "Replace Verstone/Verfire with Scorch and Resolution when available.",
        RDM.JobID
    )]
    RedMageVerprocCapstoneCombo = 3513,

    [CustomComboInfo(
        "Veraero/Verthunder Capstone Combo",
        "Replace Veraero/Verthunder with Scorch and Resolution when available.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "AoE Combo",
        "Replace Veraero/Verthunder 2 with Impact when various instant-cast effects are active.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "AoE Capstone Combo",
        "Replace Veraero/Verthunder 2 with Scorch and Resolution when available.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "Melee combo",
        "Replace Redoublement with its combo chain, following enchantment rules.",
        RDM.JobID
    )]
    RedMageMeleeCombo = 3502,

    [CustomComboInfo(
        "Melee Mana Stacks Feature",
    ...
    [CustomComboInfo(
        "Melee Capstone Combo",
        "Replace Redoublement and Moulinet with Scorch, Resolution and Prefulgence when available.",
        RDM.JobID
    )]
    RedMageMeleeCapstoneCombo = 3503,

    [CustomComboInfo(
        "Acceleration into Grand Impact",
        "Replace Acceleration with Grand Impact when available.",
        RDM.JobID
    )]
    RedMageAccelerationGrandImpactFeature = 3518,

    [CustomComboInfo(
        "Acceleration into Swiftcast",
        "Replace Acceleration with Swiftcast when on cooldown or synced.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "Acceleration with Swiftcast first",
        "Replace Acceleration with Swiftcast when neither are on cooldown.",
        RDM.JobID
    )]
    RedMageAccelerationSwiftcastOption = 3511,

    [CustomComboInfo(
        "Embolden to Manaification",
        "Replace Embolden with Manafication if the former is on cooldown and the latter is not.",
        RDM.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Contre Sixte / Fleche Feature",
        "Replace Contre Sixte and Fleche with whichever is available.",
        RDM.JobID
    )]
    ...
    [CustomComboInfo(
        "Dosis Kardia Feature",
        "Replace Dosis with Kardia when missing Kardion.",
        SGE.JobID
    )]
    SageDosisKardiaFeature = 4010,

    [CustomComboInfo(
        "Druochole into Rhizomata Feature",
        "Replace Druochole with Rhizomata when Addersgall is empty.",
        SGE.JobID
    )]
    SageDruocholeRhizomataFeature = 4003,

    [CustomComboInfo(
        "Druochole into Taurochole Feature",
    ...
    [CustomComboInfo(
        "Ixochole into Rhizomata Feature",
        "Replace Ixochole with Rhizomata when Addersgall is empty.",
        SGE.JobID
    )]
    SageIxocholeRhizomataFeature = 4004,

    [CustomComboInfo(
        "Kerachole into Rhizomata Feature",
        "Replace Kerachole with Rhizomata when Addersgall is empty.",
        SGE.JobID
    )]
    SageKeracholaRhizomataFeature = 4005,

    [CustomComboInfo(
        "Phlegma into Dyskrasia",
        "Replace Phlegma with Dyskrasia when no charges remain or have no target.",
        SGE.JobID
    )]
    SagePhlegmaDyskrasia = 4008,

    [CustomComboInfo(
        "Phlegma into Toxikon",
    ...
    [CustomComboInfo(
        "Soteria Kardia Feature",
        "Replace Soteria with Kardia when off cooldown and missing Kardion.",
        SGE.JobID
    )]
    SageSoteriaKardionFeature = 4006,

    [CustomComboInfo(
        "Taurochole into Druochole Feature",
        "Replace Taurochole with Druochole when on cooldown",
        SGE.JobID
    )]
    SageTaurocholeDruocholeFeature = 4001,

    [CustomComboInfo(
        "Taurochole into Rhizomata Feature",
        "Replace Taurochole with Rhizomata when Addersgall is empty.",
        SGE.JobID
    )]
    SageTaurocholeRhizomataFeature = 4002,

    [CustomComboInfo(
        "Toxikon into Phlegma Feature",
        "Replace Toxikon with Phlegma when charges are available.",
        SGE.JobID
    )]
    ...
    [CustomComboInfo(
        "Gekko Combo Option",
        "Start the Gekko combo chain with Jinpu instead of Hakaze.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Kasha Combo Option",
        "Start the Kasha combo chain with Shifu instead of Hakaze.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Tsubame-gaeshi to Iaijutsu",
        "Replace Tsubame-gaeshi with Iaijutsu when Sen is empty.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Tsubame-gaeshi to Shoha",
        "Replace Tsubame-gaeshi with Shoha when meditation is 3.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Iaijutsu to Tsubame-gaeshi",
        "Replace Iaijutsu with Tsubame-gaeshi when Sen is not empty.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Iaijutsu to Shoha",
        "Replace Iaijutsu with Shoha when meditation is 3.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Shinten to Zanshin",
        "Replace Hissatsu: Shinten with Zanshin when available.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Shinten to Shoha",
        "Replace Hissatsu: Shinten with Shoha when Meditation is full.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Shinten to Senei",
        "Replace Hissatsu: Shinten with Senei when available.",
        SAM.JobID
    )]
    SamuraiShintenSeneiFeature = 3414,

    [CustomComboInfo(
        "Senei to Guren Level Sync",
        "Replace Hissatsu: Senei with Guren when level synced below 72.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Kyuten to Zanshin",
        "Replace Hissatsu: Kyuten with Zanshin when available.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Kyuten to Shoha",
        "Replace Hissatsu: Kyuten with Shoha when Meditation is full.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Kyuten to Guren",
        "Replace Hissatsu: Kyuten with Guren when available.",
        SAM.JobID
    )]
    SamuraiKyutenGurenFeature = 3415,

    [CustomComboInfo(
        "Ikishoten Namikiri Feature",
    ...
    [CustomComboInfo(
        "Ikishoten Shoha Feature",
        "Replace Ikishoten with Shoha when Meditation is full.",
        SAM.JobID
    )]
    ...
    [CustomComboInfo(
        "Seraph Fey Blessing/Consolation",
        "Replace Fey Blessing with Consolation when Seraph is out.",
        SCH.JobID
    )]
    ScholarSeraphConsolationFeature = 2801,

    [CustomComboInfo(
        "Lustrate to Recitation",
        "Replace Lustrate with Recitation when Recitation is off cooldown.",
        SCH.JobID
    )]
    ScholarLustrateRecitationFeature = 2807,

    [CustomComboInfo(
        "Lustrate to Excogitation",
        "Replace Lustrate with Excogitation when Excogitation is off cooldown.",
        SCH.JobID
    )]
    ScholarLustrateExcogitationFeature = 2808,

    [CustomComboInfo(
        "Excogitation to Recitation",
        "Replace Excogitation with Recitation when Recitation is off cooldown.",
        SCH.JobID
    )]
    ScholarExcogitationRecitationFeature = 2806,

    [CustomComboInfo(
        "Excogitation to Lustrate",
        "Replace Excogitation with Lustrate when Excogitation is on cooldown.",
        SCH.JobID
    )]
    ...
    [CustomComboInfo(
        "ED Aetherflow",
        "Replace Energy Drain with Aetherflow when you have no more Aetherflow stacks.",
        SCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Lustrous Aetherflow",
        "Replace Lustrate with Aetherflow when you have no more Aetherflow stacks.",
        SCH.JobID
    )]
    ScholarLustrateAetherflowFeature = 2803,

    [CustomComboInfo(
        "Indomitable Aetherflow",
        "Replace Indomitability with Aetherflow when you have no more Aetherflow stacks.",
        SCH.JobID
    )]
    ScholarIndomAetherflowFeature = 2804,

    [CustomComboInfo(
        "Sacred Soil Aetherflow",
        "Replace Sacred Soil with Aetherflow when you have no more Aetherflow stacks.",
        SCH.JobID
    )]
    ScholarSacredSoilAetherflowFeature = 2811,

    [CustomComboInfo(
        "Summon Seraph Feature",
        "Replace Summon Eos and Selene with Summon Seraph when a summon is out.",
        SCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Seraphism Feature",
        "Replace Seraphism with Emergency Tactics as long as you are under its effect.",
        SCH.JobID
    )]
    ScholarSeraphismFeature = 2812,

    [CustomComboInfo(
        "Adloquium Level Sync",
        "Replace Adloquium with Physick when below level 30 in synced content.",
        SCH.JobID
    )]
    ...
    [CustomComboInfo(
        "Outburst Feature",
        "Change Outburst into Precious Brilliance when attuned.",
        SMN.JobID
    )]
    SummonerOutburstFeature = 2704,

    [CustomComboInfo(
        "Titan's Favor Ruin Feature",
        "Change Ruin into Mountain Buster (oGCD) when available.",
        SMN.JobID
    )]
    SummonerRuinTitansFavorFeature = 2713,

    [CustomComboInfo(
        "Titan's Favor Outburst Feature",
        "Change Outburst into Mountain Buster (oGCD) when available.",
        SMN.JobID
    )]
    SummonerOutburstTitansFavorFeature = 2714,

    [CustomComboInfo(
        "Gems Titan's Favor Feature",
        "Change Gemshine and Precious Brilliance into Mountain Buster (oGCD) when available.",
        SMN.JobID
    )]
    SummonerShinyTitansFavorFeature = 2707,

    [CustomComboInfo(
        "Ruin 4 to Ruin Feature",
        "Change Ruin into Ruin4 when available and appropriate.",
        SMN.JobID
    )]
    SummonerFurtherRuinFeature = 2705,

    [CustomComboInfo(
        "Ruin 4 to Outburst Feature",
        "Change Outburst into Ruin4 when available and appropriate.",
        SMN.JobID
    )]
    ...
    [CustomComboInfo(
        "Gems Ruin 4 Feature",
        "Change Gemshine and Precious Brilliance into Ruin 4 when available and appropriate.",
        SMN.JobID
    )]
    SummonerFurtherShinyFeature = 2708,

    [CustomComboInfo(
        "Gems Enkindle Feature",
    ...
    [CustomComboInfo(
        "ED Fester/Necrosis Feature",
        "Change Fester/Necrosis into Energy Drain when out of Aetherflow stacks.",
        SMN.JobID
    )]
    SummonerEDFesterFeature = 2701,

    [CustomComboInfo(
        "ES Painflare Feature",
        "Change Painflare into Energy Syphon when out of Aetherflow stacks.",
        SMN.JobID
    )]
    SummonerESPainflareFeature = 2702,

    [CustomComboInfo(
        "Radiant Carbuncle Feature",
        "Change Radiant Aegis into Summon Carbuncle when no pet has been summoned.",
        SMN.JobID
    )]
    ...
    [CustomComboInfo(
        "Radiant Lux Solaris Feature",
        "Change Radiant Aegis to Lux Solaris when you have Refulgent Lux ready.",
        SMN.JobID
    )]
    SummonerRadiantLuxSolarisFeature = 2718,

    [CustomComboInfo(
        "Demi Carbuncle Feature",
        "Change Summon Bahamut into Summon Carbuncle when no pet has been summoned.",
        SMN.JobID
    )]
    SummonerDemiCarbuncleFeature = 2716,

    [CustomComboInfo(
        "Summon Lux Solaris Feature",
        "Change Summon Bahamut to Lux Solaris when you have Refulgent Lux ready.",
        SMN.JobID
    )]
    ...
    [CustomComboInfo(
        "Steel Tail Feature",
        "Replace Steel Fangs and Dread Fangs with Serpent's Tail after finishing a combo.",
        VPR.JobID
    )]
    ViperSteelTailFeature = 4101,

    [CustomComboInfo(
        "Steel Tail AoE Feature",
        "Replace Steel Maw and Dread Maw with Serpent's Tail after finishing a combo.",
        VPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Twin Coil Feature",
        "Replace Swiftskin's Coil and Hunter's Coil with their respective Twinblood and Twinfang skills.",
        VPR.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Twin Den (AoE) Feature",
        "Replace Swiftskin's Den and Hunter's Den with their respective Twinblood and Twinfang skills.",
        VPR.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "All-in-one Reawaken Feature",
        "Replace Reawaken by the Generation skills with their respective Legacies in order.",
        VPR.JobID
    )]
    ViperAutoGenerationsLegaciesFeature = 4123,

    [CustomComboInfo(
        "Generation Legacy Feature",
        "Replaces the Generation skills with their respective Legacies.",
        VPR.JobID
    )]
    ViperGenerationLegaciesFeature = 4105,

    [CustomComboInfo(
        "Generation Legacy AoE Feature",
        "Replaces the AoE versions of Generation skills with their respective Legacies.",
        VPR.JobID
    )]
    ViperGenerationLegaciesAoEFeature = 4106,

    [CustomComboInfo(
        "Uncoiled Fury Followup",
        "Replaces Uncoiled Fury with Uncoiled Twinfang and Uncoiled Twinblood in sequence.",
        VPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Fury And Ire",
        "Replaces Uncoiled Fury with Serpent's Ire when out of Rattling Coil stacks.",
        VPR.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Dread Fangs to Dreadwinder",
        "Replaces Dread Fangs to Dreadwinder when there are stacks present and not currently in a combo.",
        VPR.JobID
    )]
    ...
    [SecretCustomCombo]
    [CustomComboInfo(
        "Dread Maw to Pit of Dread",
        "Replaces Dread Maw with Pit of Dread when there are stacks present and not currently in a combo.",
        VPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Merge Twinfang/Twinblood onto Serpent's Tail Feature",
        "Merge all Twinfang/Twinblood abilities onto Serpent's Tail.",
        VPR.JobID
    )]
    ...
    [CustomComboInfo(
        "Merge Serpent's Tail onto Twinfang/Twinblood Feature",
        "Merge all Serpent's Tail abilities onto Twinfang/Twinblood.",
        VPR.JobID
    )]
    ...
    [SecretCustomCombo]
    [ConflictingCombos(
        ViperPvPMainComboStartFlankstingFeature,
        ViperPvPMainComboStartHindstingFeature
    )]
    [ParentCombo(ViperPvPMainComboFeature)]
    [CustomComboInfo(
        "PvP Combo Start Flanksbane Fang",
        "With no buffs, end first combo with Flanksbane Fang.",
        VPR.JobID
    )]
    ...
    [SecretCustomCombo]
    [ConflictingCombos(
        ViperPvPMainComboStartFlanksbaneFeature,
        ViperPvPMainComboStartHindstingFeature
    )]
    [ParentCombo(ViperPvPMainComboFeature)]
    [CustomComboInfo(
        "PvP Combo Start Flanksting Strike",
        "With no buffs, end first combo with Flanksting Strike.",
        VPR.JobID
    )]
    ...
    [ParentCombo(ViperPvPMainComboFeature)]
    [CustomComboInfo(
        "PvP Combo Start Hindsting Strike",
        "With no buffs, end first combo with Hindsting Strike.",
        VPR.JobID
    )]
    ...
    [CustomComboInfo(
        "PvP AoE Combo Start Bloodied Maw",
        "With no buffs, end first combo with Bloodied Maw.",
        VPR.JobID
    )]
    ...
    [ParentCombo(WarriorStormsPathCombo)]
    [CustomComboInfo(
        "Storms Path Inner Release Feature",
        "Replace Storms Path with Fell Cleave when Inner Release is active.",
        WAR.JobID
    )]
    ...
    [CustomComboInfo(
        ...
        "Replace Mythril Tempest with its combo chain.",
        WAR.JobID
    )]
    ...
    [CustomComboInfo(
        "Mythril Tempest Overcap Feature",
    ...
    [ParentCombo(WarriorMythrilTempestCombo)]
    [CustomComboInfo(
        "Mythril Tempest Inner Release Feature",
        "Replace Mythril Tempest with Decimate when Inner Release is active.",
        WAR.JobID
    )]
    ...
    [CustomComboInfo(
        "Angry Beast Feature",
        "Replace Inner Beast and Steel Cyclone with Infuriate when less then 50 Beast Gauge is available.",
        WAR.JobID
    )]
    WarriorInfuriateBeastFeature = 2109,

    [CustomComboInfo(
        "Nascent Flash Level Sync",
        "Replace Nascent Flash with Raw intuition when Synced.",
        WAR.JobID
    )]
    WarriorNascentFlashSyncFeature = 2106,

    [CustomComboInfo(
        "Healthy Balanced Diet Feature",
    ...
    [CustomComboInfo(
        "Primal Beast Feature",
        "Replace Inner Beast and Steel Cyclone with Primal Rend when available",
        WAR.JobID
    )]
    WarriorPrimalBeastFeature = 2107,

    [CustomComboInfo(
        "Primal Release Feature",
        "Replace Inner Release with Primal Rend when available",
        WAR.JobID
    )]
    ...
    [CustomComboInfo(
        "Solace into Misery",
        "Replace Afflatus Solace with Afflatus Misery when ready.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Targeted Misery",
        "Only swap to Afflatus Misery when targeting an enemy.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Rapture into Misery",
        "Replace Afflatus Rapture with Afflatus Misery when ready and you have an enemy target.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Holy into Misery",
        "Replace Holy/Holy 3 with Afflatus Misery when ready and you have an enemy target.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Cure 2 Level Sync",
        "Replace Cure 2 with Cure when below level 30 in synced content.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Afflatus Feature",
        "Replace Cure 2 with Afflatus Solace and Medica with Afflatus Rapture when a Lily is available.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Medicafflatus Feature",
        "Also replaces Medica 2 & Medica 3 with Afflatus Rapture when a Lily is available.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Glare4 Feature",
        "Replace Glare 3 with Glare 4 when a stack is available.",
        WHM.JobID
    )]
    ...
    [CustomComboInfo(
        "Eureka Feature",
        "Replace Ageless Words and Solid Reason with Wise to the World when available.",
        DOL.JobID
    )]
    ...
    [CustomComboInfo(
        "Surface Slap / Veteran Trade Feature",
        "Replace Surface Slap with Veteran Trade when underwater.",
        DOL.JobID
    )]
    DolSurfaceTradeFeature = 51004,

    [CustomComboInfo(
        "Prize Catch / Nature's Bounty Feature",
        "Replace Prize Catch with Nature's Bounty when underwater.",
        DOL.JobID
    )]
    DolPrizeBountyFeature = 51005,

    [CustomComboInfo(
        "Snagging / Salvage Feature",
        "Replace Snagging with Salvage when underwater.",
        DOL.JobID
    )]
    DolSnaggingSalvageFeature = 51006,

    [CustomComboInfo(
        "Cast Light / Electric Current Feature",
        "Replace Cast Light with Electric Current when underwater.",
        DOL.JobID
    )]
